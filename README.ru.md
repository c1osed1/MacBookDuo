...
Обычно при закрытии крышки картинка просто гаснет. Linger держит её на 3D-плоскости, которая следует за крышкой — **Glass** замораживает кадр, **Duo+** оставляет живой стол и складывает его вокруг петли, **Frost** фиксирует картинку в комнате и уводит её молоком, пока крышка проходит сквозь неё.
